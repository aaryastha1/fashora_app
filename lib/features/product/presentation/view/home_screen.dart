...
//   bool _logoutDialogShown = false; // to avoid showing multiple dialogs fast
...
//       // Detect quick rotation on Y-axis (adjust threshold as needed)
//       if (event.y.abs() > 3) {
//         if (!mounted || _logoutDialogShown) return;
...
//         content: const Text('You rotated the device quickly. Do you want to logout?'),
//         actions: [
//           TextButton(
//             onPressed: () {
...
//     // For example, navigate to login or dashboard screen
